...
/-! # FX1PolyAudit.Tier0.Type.Level.LevelExprSimplify03

Zero-axiom audit shard mirroring kernel module `FX1Poly.Tier0.Type.Level.LevelExprSimplify` (part 3 of 7).
