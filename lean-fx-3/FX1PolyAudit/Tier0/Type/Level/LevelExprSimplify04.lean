...
/-! # FX1PolyAudit.Tier0.Type.Level.LevelExprSimplify04

Zero-axiom audit shard mirroring kernel module `FX1Poly.Tier0.Type.Level.LevelExprSimplify` (part 4 of 7).
