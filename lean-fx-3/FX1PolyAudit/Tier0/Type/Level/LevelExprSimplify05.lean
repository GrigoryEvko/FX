...
/-! # FX1PolyAudit.Tier0.Type.Level.LevelExprSimplify05

Zero-axiom audit shard mirroring kernel module `FX1Poly.Tier0.Type.Level.LevelExprSimplify` (part 5 of 7).
