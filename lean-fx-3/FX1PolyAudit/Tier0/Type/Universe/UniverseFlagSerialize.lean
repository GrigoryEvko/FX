...
/-! # FX1PolyAudit.Tier0.Type.Universe.UniverseFlagSerialize

Zero-axiom audit shard mirroring kernel module `FX1Poly.Tier0.Type.Universe.UniverseFlagSerialize`.
