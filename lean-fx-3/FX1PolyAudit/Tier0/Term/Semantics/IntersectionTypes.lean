...
/-! # FX1PolyAudit/AuditTier0TermIntersectionTypes — zero-axiom gate for term-22 (intersection types)

Per-declaration zero-axiom gate for `FX1Poly/Tier0/Term/Semantics/IntersectionTypes.lean`: the BCD
