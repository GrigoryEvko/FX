...
/-! # FX1PolyAudit.Tier0.Term.Generator.GeneratorPolygraphMap

Zero-axiom audit shard mirroring kernel module `FX1Poly.Tier0.Term.Generator.GeneratorPolygraphMap`.
