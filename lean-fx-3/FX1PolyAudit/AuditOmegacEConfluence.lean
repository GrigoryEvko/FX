...
import FX1Poly.Tier0.OmegacE.WordFreeMonoid
import FX1Poly.Tier0.OmegacE.WordFreeMonoidUniversal
import FX1Poly.Tier0.OmegacE.Rewrite
import FX1Poly.Tier0.OmegacE.Confluence
import FX1Poly.Tier0.OmegacE.WordProblem
import FX1Poly.Tier0.OmegacE.ReducerNormalizer
import FX1Poly.Tier0.OmegacE.EmptySystem
import FX1Poly.Tier0.OmegacE.IdempotentSystem
import FX1Poly.Tier0.OmegacE.IdempotentReducer
import FX1Poly.Tier0.OmegacE.IdempotentConfluence
import FX1Poly.Tier0.OmegacE.TranspositionSystem
import FX1Poly.Tier0.OmegacE.TranspositionConfluence
import FX1Poly.Tier0.OmegacE.TranspositionReducer
import FX1Poly.Tier0.OmegacE.AbsorptionSystem
import FX1Poly.Tier0.OmegacE.AbsorptionConfluence
import FX1Poly.Tier0.OmegacE.AbsorptionLocalConfluence
import FX1Poly.Tier0.OmegacE.AbsorptionReducer
import FX1Poly.Tier0.OmegacE.SortingSystem
...
import FX1Poly.Tier0.OmegacE.OmegacEFiniteType

/-! # FX1PolyAudit/AuditOmegacEConfluence — omega-cE-layer zero-axiom gates, shard 01 of 2 (split from the AuditOmegacE monolith for parallel gate elaboration).  Covers the dimension-1 free monoid + universal property, dimension-2 word rewriting / convertibility / confluence framework, Newman's lemma, length-measure termination, the decided word problem + normalizer, and the first two concrete decided presentations (empty + idempotent). -/
