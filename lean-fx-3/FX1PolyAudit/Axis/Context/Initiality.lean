...
/-! # FX1PolyAudit/AuditAxisContextInitiality — zero-axiom gate for context-5's object-level residue

Per-declaration zero-axiom gate for `context-5`'s strictly context-side deliverable
(`FX1Poly/Axis/Context/Initiality.lean`): the object-level fragment of the INITIALITY theorem — the
...
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebra
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebra.realizeScope
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebra.realizeScope_zero
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebra.realizeScope_succ

-- The initiality core: uniqueness of the realization + pointwise rigidity of any two homomorphisms
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebra.realizeScope_unique
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebra.realization_unique_pointwise

-- The syntactic context structure as an algebra + reflexive initiality + tie to context-3's colimit
#assert_no_axioms FX1Poly.Axis.fxBaseSubstContextAlgebra
#assert_no_axioms FX1Poly.Axis.fxBaseSubstContextAlgebra_realizeScope_id
#assert_no_axioms FX1Poly.Axis.fxBaseSubstContextAlgebra_emptyContext_isInitial

-- The initial-algebra packaging (Lambek): the morphisms of context-extension algebras + their category
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebraMorphism
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebraMorphism.identity
#assert_no_axioms FX1Poly.Axis.ContextExtensionAlgebraMorphism.compose

-- The syntactic algebra is the initial object: the unique realization morphism + its uniqueness/idem
#assert_no_axioms FX1Poly.Axis.syntacticRealizationMorphism
#assert_no_axioms FX1Poly.Axis.syntacticRealizationMorphism_unique
#assert_no_axioms FX1Poly.Axis.syntacticRealizationMorphism_self_is_identity

-- The non-vacuous faithful witness model (contexts as telescopes of unit-bindings)
#assert_no_axioms FX1Poly.Axis.unaryListAlgebra
#assert_no_axioms FX1Poly.Axis.realizeScope_unaryList_length
#assert_no_axioms FX1Poly.Axis.realizeScope_unaryList_injective
