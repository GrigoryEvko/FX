...
/-! # FX1PolyAudit/AuditAxisContextComprehensionCategory — zero-axiom gate for context-10

Per-declaration zero-axiom gate for `context-10`'s context-side deliverable
(`FX1Poly/Axis/Context/ComprehensionCategory.lean`): the FX context base as a split COMPREHENSION
...
#assert_no_axioms FX1Poly.Axis.IsSplitDisplayFibration
#assert_no_axioms FX1Poly.Axis.fxDisplaySplitFibration
#assert_no_axioms FX1Poly.Axis.SubstVec.comprehensionBackward_natural
#assert_no_axioms FX1Poly.Axis.SubstVec.comprehensionForward_natural
#assert_no_axioms FX1Poly.Axis.FxComprehensionCategory
#assert_no_axioms FX1Poly.Axis.fxComprehensionCategory
#assert_no_axioms FX1Poly.Axis.fxComprehensionCategory_hasFibredPiRightAdjoint
#assert_no_axioms FX1Poly.Axis.fxComprehensionCategory_representability_backward_smoke
