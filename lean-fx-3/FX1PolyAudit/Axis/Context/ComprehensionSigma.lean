...
import FX1Poly.Axis.Context.ComprehensionSigma

/-! # FX1PolyAudit/AuditAxisContextComprehension — zero-axiom gate for context-1's comprehension + Σ

Per-declaration zero-axiom gate for `context-1`'s comprehension + Frobenius-Σ
deliverable (`FX1Poly/Axis/Context/ComprehensionSigma.lean`): the new
...
#assert_no_axioms FX1Poly.Axis.SubstVec.cons_compose
#assert_no_axioms FX1Poly.Axis.fxContextComprehension
