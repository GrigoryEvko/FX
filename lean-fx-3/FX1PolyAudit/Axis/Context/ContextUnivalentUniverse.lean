...
(`FX1Poly/Axis/Context/ContextUnivalentUniverse.lean`): the context category's universe object as a
...
#assert_no_axioms FX1Poly.Axis.CategoryIso
#assert_no_axioms FX1Poly.Axis.CategoryIso.identityIso
#assert_no_axioms FX1Poly.Axis.CategoryIso.symm
#assert_no_axioms FX1Poly.Axis.CategoryIso.toIsIsomorphism

-- The comparison map + the univalence datum
#assert_no_axioms FX1Poly.Axis.idToIso
#assert_no_axioms FX1Poly.Axis.idToIso_refl
#assert_no_axioms FX1Poly.Axis.IsUnivalentUniverseObject

-- The zero-axiom witness: the set-level universe object is univalent
#assert_no_axioms FX1Poly.Axis.discreteUniverseObject
#assert_no_axioms FX1Poly.Axis.discreteUniverseObject_isUnivalent

-- Honesty markers + smoke
#assert_no_axioms FX1Poly.Axis.fxContextUniverse_hasCategoricalUnivalence
#assert_no_axioms FX1Poly.Axis.fxContextUniverse_hasUnivalenceAxiom
#assert_no_axioms FX1Poly.Axis.discreteUniverseObject_isoToId_idToIso_smoke
