...
import FX1Poly.Axis.Context.MultimodalNormalization

/-! # FX1PolyAudit/AuditAxisContextMultimodalNormalization — zero-axiom gate for context-12's NbE

Per-declaration zero-axiom gate for `context-12`'s context-side deliverable
(`FX1Poly/Axis/Context/MultimodalNormalization.lean`): Gratzer-style multimodal NbE over the modal base,
...
#assert_no_axioms FX1Poly.Axis.NbeRetraction
#assert_no_axioms FX1Poly.Axis.NbeRetraction.normalize
#assert_no_axioms FX1Poly.Axis.NbeRetraction.eval_normalize
#assert_no_axioms FX1Poly.Axis.NbeRetraction.normalize_idempotent
#assert_no_axioms FX1Poly.Axis.NbeRetraction.normalize_complete
#assert_no_axioms FX1Poly.Axis.NbeRetraction.eval_eq_of_normalize_eq
#assert_no_axioms FX1Poly.Axis.NbeRetraction.normalize_eq_iff_eval_eq

-- reify for the substitution calculus + the section law
#assert_no_axioms FX1Poly.Axis.SubstExpr.emptyToScope
#assert_no_axioms FX1Poly.Axis.SubstVec.reify
#assert_no_axioms FX1Poly.Axis.SubstExpr.denote_reify

-- The concrete substitution-calculus NbE + soundness + the conversion characterization
#assert_no_axioms FX1Poly.Axis.fxSubstNbe
#assert_no_axioms FX1Poly.Axis.fxSubstNormalize
#assert_no_axioms FX1Poly.Axis.fxSubstNormalize_denote
#assert_no_axioms FX1Poly.Axis.fxSubstConv_iff

-- The bridge to context-8's σ-rewriting (NbE normal form is a rewriting invariant)
#assert_no_axioms FX1Poly.Axis.fxSubstNormalize_substStep_invariant
#assert_no_axioms FX1Poly.Axis.fxSubstNormalize_substStepStar_invariant

-- The assembled witness + honesty markers + smoke
#assert_no_axioms FX1Poly.Axis.FxMultimodalNbe
#assert_no_axioms FX1Poly.Axis.fxMultimodalNbe
#assert_no_axioms FX1Poly.Axis.fxMultimodalNbe_hasTypedTermReification
#assert_no_axioms FX1Poly.Axis.fxMultimodalNbe_hasModalLockThreading
#assert_no_axioms FX1Poly.Axis.fxMultimodalNbe_normalize_idempotent_smoke
