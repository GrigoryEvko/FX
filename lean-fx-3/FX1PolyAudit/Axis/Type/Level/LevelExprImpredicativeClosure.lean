...
import FX1Poly.Axis.Type.Level.LevelExprImpredicativeClosure

/-! # FX1PolyAudit.Axis.Type.Level.LevelExprImpredicativeClosure

Zero-axiom audit shard mirroring kernel module `FX1Poly.Axis.Type.Level.LevelExprImpredicativeClosure`.
