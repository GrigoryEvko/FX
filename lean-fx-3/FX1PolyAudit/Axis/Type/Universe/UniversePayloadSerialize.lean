...
import FX1Poly.Axis.Type.Universe.UniversePayloadSerialize

/-! # FX1PolyAudit.Axis.Type.Universe.UniversePayloadSerialize

Zero-axiom audit shard mirroring kernel module `FX1Poly.Axis.Type.Universe.UniversePayloadSerialize`.
