...
/-! # FX1PolyAudit/AuditAxisTermCopatternCoverage — zero-axiom gate for term-15 (copattern coverage)

Per-declaration zero-axiom gate for `FX1Poly/Axis/Term/Codata/CopatternCoverage.lean`: the copattern trie +
