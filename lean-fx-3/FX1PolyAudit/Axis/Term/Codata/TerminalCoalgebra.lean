...
/-! # FX1PolyAudit/AuditAxisTermTerminalCoalgebra — zero-axiom gate for term-3 (terminal coalgebra)

Per-declaration zero-axiom gate for `FX1Poly/Axis/Term/Codata/TerminalCoalgebra.lean`: the terminal
