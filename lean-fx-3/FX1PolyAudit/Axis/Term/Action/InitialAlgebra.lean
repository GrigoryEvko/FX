...
/-! # FX1PolyAudit/AuditAxisTermInitialAlgebra — zero-axiom gate for term-1 (the genuine initiality)

Per-declaration zero-axiom gate for `FX1Poly/Axis/Term/Action/InitialAlgebra.lean`: RawTerm is the
