...
import FX1Poly.Axis.Term.Subst.FragmentTermCellAction

/-! # FX1PolyAudit.Axis.Term.Subst.FragmentTermCellActionAudit — zero-axiom gate for the OMEGA-7 r4 action
(OMEGA-7 r4).
