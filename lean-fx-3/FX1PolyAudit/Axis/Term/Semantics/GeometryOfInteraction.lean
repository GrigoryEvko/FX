...
/-! # FX1PolyAudit/AuditAxisTermGeometryOfInteraction — zero-axiom gate for term-23 (GoI token machine)

Per-declaration zero-axiom gate for `FX1Poly/Axis/Term/Semantics/GeometryOfInteraction.lean`: the token
