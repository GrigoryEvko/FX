...
/-! # FX1PolyAudit/AuditAxisTermGameSemantics — zero-axiom gate for term-24 (game semantics)

Per-declaration zero-axiom gate for `FX1Poly/Axis/Term/Semantics/GameSemantics.lean`: the polarity duality
