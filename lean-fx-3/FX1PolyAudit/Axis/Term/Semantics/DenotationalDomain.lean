...
/-! # FX1PolyAudit/AuditAxisTermDenotationalDomain — zero-axiom gate for term-21 (domain fixpoint)

Per-declaration zero-axiom gate for `FX1Poly/Axis/Term/Semantics/DenotationalDomain.lean`: the pointed
