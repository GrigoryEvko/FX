...
/-! # FX1PolyAudit.Axis.Term.Generator.GeneratorTagRoundTrip

Zero-axiom audit shard mirroring kernel module `FX1Poly.Axis.Term.Generator.GeneratorTagRoundTrip`.
