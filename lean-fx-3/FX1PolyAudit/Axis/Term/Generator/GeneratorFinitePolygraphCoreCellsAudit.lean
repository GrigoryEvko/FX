...
/-! # FX1PolyAudit.Axis.Term.Generator.GeneratorFinitePolygraphCoreCellsAudit

Zero-axiom audit shard mirroring kernel module `FX1Poly.Axis.Term.Generator.GeneratorFinitePolygraph`.
