...
TYTAB-2-FT, #1697): the ofGrown arm at an ARBITRARY context (`ofGrownCongruence`) and its empty-context
specialization (`ofGrownCongruenceAtEmptyContext`), both discharged through the grown master.  Must be free
of `propext`, `Quot.sound`, `Classical.choice`, `sorry`, `native_decide`, `omega`. -/

namespace FX1PolyAudit

#assert_no_axioms FX1Poly.Typed.HasTypeUnion.ofGrownCongruence
