...
/-! # FX1PolyAudit/AuditTier0TermSubstitutionMonoid — zero-axiom gate for term-10 (FPT substitution monoid)

Per-declaration zero-axiom gate for `FX1Poly/Tier0/Term/Action/SubstitutionMonoid.lean`: the Fiore-Plotkin-
