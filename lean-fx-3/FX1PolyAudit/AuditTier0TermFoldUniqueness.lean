...
/-! # FX1PolyAudit/AuditTier0TermFoldUniqueness — zero-axiom gate for term-1 (uniqueness leg)

Per-declaration zero-axiom gate for `FX1Poly/Tier0/Term/Action/FoldUniqueness.lean`: the recursor
