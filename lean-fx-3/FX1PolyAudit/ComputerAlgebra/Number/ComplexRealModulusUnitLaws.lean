...
Per-declaration zero-axiom gate for the modulus unit laws: nonnegativity of the
real unit, the modulus congruence over the product setoid, and the three
equalities `|conj z| ~ |z|`, `|1| ~ 1`, `|z⁻¹| * |z| ~ 1`.
