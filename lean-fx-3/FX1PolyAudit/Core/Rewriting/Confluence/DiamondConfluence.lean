...
/-! # FX1PolyAudit.Core.Rewriting.Confluence.DiamondConfluence

Zero-axiom audit shard mirroring kernel module `FX1Poly.Core.Rewriting.Confluence.DiamondConfluence`.
