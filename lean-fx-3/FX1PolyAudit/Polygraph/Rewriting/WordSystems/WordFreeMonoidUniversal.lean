...
import FX1Poly.Polygraph.Rewriting.WordSystems.WordFreeMonoidUniversal

/-! # FX1PolyAudit.Polygraph.OmegacE.WordFreeMonoidUniversal

Zero-axiom audit shard mirroring kernel module `FX1Poly.Polygraph.OmegacE.WordFreeMonoidUniversal`.
