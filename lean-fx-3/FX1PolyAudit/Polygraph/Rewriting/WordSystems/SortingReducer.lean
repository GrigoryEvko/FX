...
import FX1Poly.Polygraph.Rewriting.WordSystems.SortingReducer

/-! # FX1PolyAudit.Polygraph.OmegacE.SortingReducer

Zero-axiom audit shard mirroring kernel module `FX1Poly.Polygraph.OmegacE.SortingReducer`.
