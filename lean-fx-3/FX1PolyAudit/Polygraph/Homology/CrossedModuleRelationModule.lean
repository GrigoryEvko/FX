...
#assert_no_axioms FX1Poly.Polygraph.Homology.groupRingZScale
#assert_no_axioms FX1Poly.Polygraph.Homology.genE0
#assert_no_axioms FX1Poly.Polygraph.Homology.genE1
#assert_no_axioms FX1Poly.Polygraph.Homology.genE2
#assert_no_axioms FX1Poly.Polygraph.Homology.repeatGenPos
#assert_no_axioms FX1Poly.Polygraph.Homology.repeatGen
#assert_no_axioms FX1Poly.Polygraph.Homology.intSuccScale
#assert_no_axioms FX1Poly.Polygraph.Homology.imageRepeatGenPos
#assert_no_axioms FX1Poly.Polygraph.Homology.negSuccScaleNeg
#assert_no_axioms FX1Poly.Polygraph.Homology.imageRepeatGen
#assert_no_axioms FX1Poly.Polygraph.Homology.groupRingZScaleE0
#assert_no_axioms FX1Poly.Polygraph.Homology.groupRingZScaleE1
#assert_no_axioms FX1Poly.Polygraph.Homology.groupRingZScaleE2
#assert_no_axioms FX1Poly.Polygraph.Homology.imageRepeatGenE0
#assert_no_axioms FX1Poly.Polygraph.Homology.imageRepeatGenE1
#assert_no_axioms FX1Poly.Polygraph.Homology.imageRepeatGenE2
#assert_no_axioms FX1Poly.Polygraph.Homology.realizeAugmentationZeroIdentity
#assert_no_axioms FX1Poly.Polygraph.Homology.realizeRoundTrip
#assert_no_axioms FX1Poly.Polygraph.Homology.crossedModuleImageSurjectsOntoGroupRing
#assert_no_axioms FX1Poly.Polygraph.Homology.realizeProbeListTwoNegOneNegOne
#assert_no_axioms FX1Poly.Polygraph.Homology.realizeProbeImageTwoNegOneNegOne
#assert_no_axioms FX1Poly.Polygraph.Homology.realizeProbeImageZeroThreeNegThree
#assert_no_axioms FX1Poly.Polygraph.Homology.sActOnGen
#assert_no_axioms FX1Poly.Polygraph.Homology.groupRingSActionPowerOfT
#assert_no_axioms FX1Poly.Polygraph.Homology.groupRingSActionSignScale
#assert_no_axioms FX1Poly.Polygraph.Homology.groupRingSActionAdd
#assert_no_axioms FX1Poly.Polygraph.Homology.conjugatedRelatorImageSActOnGen
#assert_no_axioms FX1Poly.Polygraph.Homology.crossedModuleImageSActOnGen
#assert_no_axioms FX1Poly.Polygraph.Homology.rotationIdentityWitnessSecond
#assert_no_axioms FX1Poly.Polygraph.Homology.rotationIdentityWitnessThird
#assert_no_axioms FX1Poly.Polygraph.Homology.rotationIdentityWitnessSecondImage
#assert_no_axioms FX1Poly.Polygraph.Homology.rotationIdentityWitnessThirdImage
#assert_no_axioms FX1Poly.Polygraph.Homology.rotationIdentityWitnessSecondBoundaryVanishes
