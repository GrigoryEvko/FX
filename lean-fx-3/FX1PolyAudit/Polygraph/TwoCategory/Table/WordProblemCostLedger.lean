...
cost-evidence taxonomies, the two total maps over the live decided-16 enum, the kernel-checked class/evidence
...
#assert_no_axioms FX1Poly.Polygraph.Table.wordProblemCostCitedWalkerCountIsSixteen
...
#assert_no_axioms FX1Poly.Polygraph.Table.wordProblemLinearCostWalkerCountIsEight
...
#assert_no_axioms FX1Poly.Polygraph.Table.wordProblemCostClassifiedWalkerCountIsSixteen
