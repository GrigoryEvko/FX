...
Per-declaration zero-axiom gate for the disjoint-window whisker factorization: the inert middle
path with both context decompositions and the gap-length pin.
