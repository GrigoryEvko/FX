...
coinductive ⊆ inductive collapse, the fixpoints-agree `↔`, the reduct-operator guard bridge, and the
CONDITIONAL FX collapse (honest hypothesis: raw well-foundedness, globally false).
