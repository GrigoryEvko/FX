...
/-! # FX1PolyAudit.Typed.Shards.StrengthenReflection.Part01 — zero-axiom gate shard (part 1/2 of AuditTypedStrengthenReflection)

Chunk-split slice of the former monolithic `AuditTypedStrengthenReflection` semantic shard so each audit file
