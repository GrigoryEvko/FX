...
/-! # FX1PolyAudit.Typed.Shards.DefenseCorpus.Part02 — zero-axiom gate shard (part 2/2 of AuditTypedDefenseCorpus)

Chunk-split slice of the former monolithic `AuditTypedDefenseCorpus` semantic shard so each audit file
