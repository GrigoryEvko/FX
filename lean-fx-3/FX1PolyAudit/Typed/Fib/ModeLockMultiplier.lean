...
#assert_no_axioms FX1Poly.Core.Fib.dimensionUsePositionLockMultiplier
#assert_no_axioms FX1Poly.Core.Fib.dimensionUsePositionLockMultiplier_isUnpointable
#assert_no_axioms FX1Poly.Core.Fib.lockFibrantInaccessibility_witnessedByUnpointedMultiplier
#assert_no_axioms FX1Poly.Core.Fib.dimensionUsePositionLockMultiplier_isDimensionallySplit
#assert_no_axioms FX1Poly.Core.Fib.dimensionUsePositionLockSplit_witnessedByMultiplier
#assert_no_axioms FX1Poly.Core.Fib.dimensionUsePositionLockMultiplier_notPointed
#assert_no_axioms FX1Poly.Core.Fib.dimensionUsePositionLockMultiplier_pointedDecidable
