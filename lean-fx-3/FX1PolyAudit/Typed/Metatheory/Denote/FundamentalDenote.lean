...
/-! # FX1PolyAudit.Typed.Metatheory.Denote.FundamentalDenote
    — zero-axiom gate for the denote-keyed fundamental theorem arms (part 1/3)
...
#assert_no_axioms FX1Poly.Typed.ReducibleTypeStepDenote.candidateCarrierAwareShape
#assert_no_axioms FX1Poly.Typed.IsReducibleTypeAtAllDenoteLevels.ofDataFlatCarrierAware
