...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Bounded.FundamentalBoundedMore2
    — zero-axiom gate for the bounded-reducibility fundamental theorem arms (part 3/6)
