...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Bounded.FundamentalBoundedMore
    — zero-axiom gate for the bounded-reducibility fundamental theorem arms (part 2/6)
