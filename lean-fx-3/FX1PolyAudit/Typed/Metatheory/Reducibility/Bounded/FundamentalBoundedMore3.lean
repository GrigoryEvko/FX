...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Bounded.FundamentalBoundedMore3
    — zero-axiom gate for the bounded-reducibility fundamental theorem arms (part 4/6)
