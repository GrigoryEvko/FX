...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Bounded.FundamentalBoundedMore4
    — zero-axiom gate for the bounded-reducibility fundamental theorem arms (part 5/6)
