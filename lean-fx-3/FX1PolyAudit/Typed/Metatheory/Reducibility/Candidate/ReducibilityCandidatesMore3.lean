...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Candidate.ReducibilityCandidatesMore3
    — zero-axiom gate for the reducibility-candidate substrate (FTGEN candidate validity / member arms) (part 4/8)
