...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Candidate.ReducibilityCandidatesMore
    — zero-axiom gate for the reducibility-candidate substrate (FTGEN candidate validity / member arms) (part 2/8)
