...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Candidate.ReducibilityCandidates
    — zero-axiom gate for the reducibility-candidate substrate (FTGEN candidate validity / member arms) (part 1/8)
