...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Candidate.ReducibilityCandidatesMore4
    — zero-axiom gate for the reducibility-candidate substrate (FTGEN candidate validity / member arms) (part 5/8)
