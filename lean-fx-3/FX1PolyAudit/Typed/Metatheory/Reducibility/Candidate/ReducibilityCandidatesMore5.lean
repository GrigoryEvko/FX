...
/-! # FX1PolyAudit.Typed.Metatheory.Reducibility.Candidate.ReducibilityCandidatesMore5
    — zero-axiom gate for the reducibility-candidate substrate (FTGEN candidate validity / member arms) (part 6/8)
