...
import FX1Poly.Tier0.Term.Rename.LiftsRaw
...
via `DecidableEq Generator`.  No wildcard match, no 205-arm
enumeration in the recursion body itself.

## The scope-invariance helper (one-place 205-arm enumeration)
...
rfls).  The 205-arm enumeration lives in ONE place (this helper),
...
/-- The 205-arm enumeration in ONE place: for any non-variable
...
this equality.  The 205 generators are enumerated once HERE; every
