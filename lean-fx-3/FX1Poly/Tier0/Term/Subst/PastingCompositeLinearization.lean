...
/-! # Tier0/Term/Subst/PastingCompositeLinearization — COMPOSITION = pasting at chain granularity
...
`substCompose_assoc` (Tier0) forces this placement (Polygraph may not import Tier0).  The declarations keep
