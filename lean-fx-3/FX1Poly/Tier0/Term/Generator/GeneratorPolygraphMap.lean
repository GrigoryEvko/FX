...
presenting each of the 205 generators with its boundary, faithfully.
...
(`congrArg`) and `Generator.toNat_injective` — the boundary presentation separates all 205 generators. -/
