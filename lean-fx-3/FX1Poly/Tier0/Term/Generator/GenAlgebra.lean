import FX1Poly.Tier0.Term.Subst.RawTermSubstDefs
...
payload foldedChildren` typechecks UNIFORMLY for all 205 generators
...
205 generators.  Future variants (NbE eval, term-size, ...) can
...
uniformly to all 205 generators in ONE line: rebuild the input
