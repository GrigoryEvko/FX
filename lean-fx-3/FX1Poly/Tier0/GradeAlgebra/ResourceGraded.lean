...
that namespace, so renaming the namespace to `FX1Poly.Tier0.GradeAlgebra` is deferred to the later
Core↔Tier0 dependency-inversion pass, which decouples those consumers holistically.
