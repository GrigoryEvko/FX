...
/-! # Tier0/Mode/ExhibitedConvergentDecision — the Tier-C (exhibited-convergent) 2-cell decision (Squier / KB)
...
Lives in `Tier0/Mode/` (cross-layer top file — the ledger pins reference it) although its declarations are
