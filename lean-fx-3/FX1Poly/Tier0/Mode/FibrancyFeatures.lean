...
The **φ (Geometric) coordinate** of the `GradedSpectrum` (see `Tier0/Mode/GradedSpectrum.lean`).
This file gives the finer READING of the ONE shipped fibrancy mode property (`Tier0/Mode/FibrancyMode`,
...
This file imports only its `Tier0/Mode` siblings (`AdjointModeSignature`, transitively `FibrancyMode`);
