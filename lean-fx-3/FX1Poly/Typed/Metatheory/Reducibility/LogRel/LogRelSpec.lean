...
1. **Full `Type`-valued induction-recursion (Adjedj `LRTy`/`LRTm` verbatim).**  Lean 4 supports IR natively,
   but a `Type`-valued logical relation over the 205-generator table is heavy and risks positivity /
...
open FX1Poly.Core FX1Poly.Core.StepStar FX1Poly.Axis.Syntax
