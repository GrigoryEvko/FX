...
theorem HasTypeUnion.invertAtPairHead {profile : PolyProfile} {scope : Nat}
  ...
  obtain ⟨firstType, secondType, firstTyped, secondTyped, converts⟩ :=
    HasTypeUnionNativeOnly.invertAtPairHead derivation.toNativeOnly subjectShape
  exact ⟨firstType, secondType, firstTyped.toUnion, secondTyped.toUnion, converts⟩
...
theorem HasTypeUnion.invertAtOptionSomeHead {profile : PolyProfile} {scope : Nat}
  ...
  obtain ⟨payloadType, payloadTyped, converts⟩ :=
    HasTypeUnionNativeOnly.invertAtOptionSomeHead derivation.toNativeOnly subjectShape
  exact ⟨payloadType, payloadTyped.toUnion, converts⟩
...
theorem HasTypeUnion.invertAtEitherInlHead {profile : PolyProfile} {scope : Nat}
  ...
  obtain ⟨leftType, rightType, payloadTyped, converts⟩ :=
    HasTypeUnionNativeOnly.invertAtEitherInlHead derivation.toNativeOnly subjectShape
  exact ⟨leftType, rightType, payloadTyped.toUnion, converts⟩
...
theorem HasTypeUnion.invertAtEitherInrHead {profile : PolyProfile} {scope : Nat}
    ...
    ∃ leftType rightType : RawTerm scope,
      ...
      Conv (eitherTypeCell leftType rightType) classifier := by
  obtain ⟨leftType, rightType, payloadTyped, converts⟩ :=
    HasTypeUnionNativeOnly.invertAtEitherInrHead derivation.toNativeOnly subjectShape
  exact ⟨leftType, rightType, payloadTyped.toUnion, converts⟩
...
theorem HasTypeUnion.invertAtListConsHead {profile : PolyProfile} {scope : Nat}
  ...
  obtain ⟨elementType, headTyped, tailTyped, converts⟩ :=
    HasTypeUnionNativeOnly.invertAtListConsHead derivation.toNativeOnly subjectShape
  exact ⟨elementType, headTyped.toUnion, tailTyped.toUnion, converts⟩
