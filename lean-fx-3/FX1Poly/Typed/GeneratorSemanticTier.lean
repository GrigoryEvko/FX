...
The honest semantic classification of every one of the 205 generators, combining the two axes shipped before
...
honest live/reserved partition of all 205 generators. -/
