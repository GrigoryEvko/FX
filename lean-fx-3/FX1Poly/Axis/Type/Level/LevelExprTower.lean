...
/-! # FX1Poly/Axis/Type/Level/LevelExprTower — the n-fold-`lsucc` tower ℕ ↪ LevelExpr
...
level expressions.  This is term-INDEPENDENT — it lives purely in the Axis level algebra (`LevelExpr`,
