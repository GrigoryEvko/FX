...
This file extends `FX1Poly/Axis/Mode/Provability.lean` (which ships GL soundness `boxOver` / `boxOver_loeb`
...
Zero external dependencies; raw Lean 4 + `Init` only.  Imports `FX1Poly.Axis.Mode.Provability` for `boxAt`.
-/
