/-! # Axis/Term — intersection types: BCD subtyping + the filter model (term-22)
...
`native_decide`, or `omega`.  Per-declaration gated in `FX1PolyAudit/AuditAxisTermIntersectionTypes.lean`.
-/
