/-! # Axis/Term — the terminal coalgebra of the stream functor (term-3, RIGHT / co-signature)
...
`native_decide`, or `omega`.  Per-declaration gated in `FX1PolyAudit/AuditAxisTermTerminalCoalgebra.lean`.
-/
