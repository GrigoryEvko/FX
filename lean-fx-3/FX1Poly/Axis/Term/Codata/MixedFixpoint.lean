/-! # Axis/Term — mixed inductive-coinductive types: the μ/ν parity (term-14)
...
`native_decide`, `omega`.  Per-declaration gated in `FX1PolyAudit/AuditAxisTermMixedFixpoint.lean`.
-/
