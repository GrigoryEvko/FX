import FX1Poly.Axis.Term.Rename.RawTermRenameCompose
...
theorem RawTerm.rename_compose_var_smoke
    {sourceScope middleScope targetScope : Nat}
    (firstRenaming :
        FX1Poly.Axis.Syntax.RawRenaming (sourceScope + 1) (middleScope + 1))
    (secondRenaming :
        FX1Poly.Axis.Syntax.RawRenaming (middleScope + 1) (targetScope + 1)) :
    RawTerm.rename secondRenaming
        (RawTerm.rename firstRenaming
            (.mkGen .gen_var
