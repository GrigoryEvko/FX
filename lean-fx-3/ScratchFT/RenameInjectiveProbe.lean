...
/-! Probe: term-level rename injectivity from Fin-injectivity — the missing prerequisite for
`Conv.reflectRename` at `lift ρ` (the pinned reflection's piIntro arm works under binders, where the
renaming is `lift ρ`, and `Conv.reflectRename` demands TERM-level injectivity there). -/
...
#print axioms FX1Poly.Core.RawTerm.rename_injective
#print axioms FX1Poly.Core.RawTermChildren.rename_injective
#print axioms FX1Poly.Core.RawRenaming.iterateLiftRaw_injective
#print axioms FX1Poly.Core.Conv.reflectRenameOfFinInjective
#print axioms FX1Poly.Core.Conv.reflectLiftRename
