...
/-! Probe: STR-8b whnf DISPATCHER — reduce the full piElim residual to two HEAD-SPECIFIC
residuals (λ-headed-after-whnf + neutral-app-headed-after-whnf).  Pipeline: grown-wf open SN
(shipped this campaign) → normalize the function → SR-star types the normal reduct → wf-FREE
λ-or-neutral canonical forms (the shipped one carries a VESTIGIAL formation-wf premise the motive
cannot supply) → var reduct routes to the shipped ReducesToVarArm; λ and neutral-app reducts
route to the named residuals. -/
...
#print axioms FX1Poly.Typed.HasTypeDescPi.normalSubjectCanonicalOrNeutralOfTyping
#print axioms FX1Poly.Typed.HasTypeDescPi.normalFunctionIsLambdaOrNeutralOfTyping
#print axioms FX1Poly.Typed.pinnedReflectionPiElimResidualOfHeadResiduals
