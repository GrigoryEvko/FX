...
/-! # ScratchFT/HasTypeDescPiFundamentalVectorFromFormation
    — prototype: grown-engine vector FT from the formation-fragment vector FT
-/
...
theorem HasTypeDescPi.fundamentalVectorFromFormation {profile : PolyProfile}
  ...
  · intro _baseScope _currentDepth _restShifts _context _head _headLevel _restLevels _flag _rest
    ...
    intro _targetScope substitution _envLevels _predLevel env shapeEq
    ...
    · exact restFundamental (RawTermSubst.cons argument substitution) _predLevel
