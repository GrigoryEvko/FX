...
/-! Scratch probe: the graded SUBSTITUTION lemma + β-subject-reduction for HasUsage (the DIM2-3
soundness payoff).  Result grade of `substAt cut arg body` = `removeAt cut p + (gradeAt cut p)·q`
where p = body grades, q = arg grades.  The λ-case threads via front-weakening (cut-0 of
hasUsage_weakening) and `substInto (d+1) (cons 0 q) (cons bg p) = cons bg (substInto d q p)`. -/

namespace FX1Poly.Modal

/-! ### Positional removal ops (mirror the insertion ops of the metatheory file) -/
...
theorem removeTypeAt_length :
  ...
  | 0, _ :: _, _ => rfl
  | depth + 1, [], lt => absurd lt (Nat.not_lt_zero _)
...
vector preserved EXACTLY (unlike the naive occurrence check, which `usage_check_fails_subject_reduction`
showed fails here).  `(λ.body) arg ↝ body[0 := arg]`: invert App + Lam, then the substitution lemma
at cut 0, where `substInto 0 argGrades (cons binderGrade functionGrades)` is definitionally
`functionGrades + binderGrade · argGrades` = the redex's grade. -/
...
#print axioms removeAt_add
#print axioms removeAt_scale
#print axioms gradeAt_scale
#print axioms gradeAt_add
#print axioms add_interchange
#print axioms substInto_single_self
#print axioms substInto_single_lt
#print axioms substInto_single_gt
#print axioms substInto_appGrade
#print axioms substInto_succ_cons
#print axioms removeTypeAt_length
#print axioms lookup_removeTypeAt_lt
#print axioms lookup_removeTypeAt_ge
#print axioms gradeAt_zero
#print axioms removeAt_zero
#print axioms gradeAt_single_self
#print axioms gradeAt_single_ne
#print axioms removeAt_single_self
#print axioms removeAt_single_lt
#print axioms removeAt_single_gt
