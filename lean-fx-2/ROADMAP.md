...
5. **D2.5 typed cubical β cascade** — D2.5.1 #1527 ✅, D2.5.2 #1528 ✅, D2.5.3 #1529 ✅ verified, D2.5.4 #1555 ✅ (Phase G activation), D2.5.8 #1559 ✅.  Pending: D2.5.5 #1556 (foundation shipped 2026-05-15, cascade rolled back 2026-05-15 on `Step.eta` blocker — see #1951), D2.5.6 #1557 (blocked on Term.transpFill #1948), D2.5.7 #1558, D2.5.9 #1560.  Shared blocker #1951 cd_lemma dispatch eta-bottleneck affects 5/7 remaining; resolution requires `Step.eta` kernel ctor (multi-day cascade).
