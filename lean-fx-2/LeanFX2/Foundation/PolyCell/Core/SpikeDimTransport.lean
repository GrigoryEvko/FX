...
namespace LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport
...
end LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport

-- ═══════════════════════════════════════════════════════════════════
-- THE VERDICT
-- ═══════════════════════════════════════════════════════════════════
#print axioms LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport.SpikeRawCell
#print axioms LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport.SpikeRawCell.dim
#print axioms LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport.SpikeBoundary
#print axioms LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport.SpikeCertCell
#print axioms LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport.buildConcrete
#print axioms LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport.buildGeneral
#print axioms LeanFX2.Foundation.PolyCell.Core.SpikeDimTransport.buildConcrete_eq
