/-! # Foundation/PolyCell/Core/SiteOpennessV2 — open/closed spectrum tag
...
| File                          | Domain     | Pattern              |
| ----------------------------- | ---------- | -------------------- |
| GeneratorTotalityClassV2      | 194 gens   | list-based exclusion |
| ConsistencyStrengthV2         | profiles   | Nat rank + LE        |
| SiteOpennessV2 (THIS FILE)    | profiles   | Nat rank + LE        |
