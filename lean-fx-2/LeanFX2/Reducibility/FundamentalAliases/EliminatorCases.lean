...
The four direct SN endpoints — boolElim / idJ / oeqJ / idStrictRec —
now live in `FundamentalAliases.DirectCases` (bypass-free).  They are
visible here via the transitive `import` above. -/
