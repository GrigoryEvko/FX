...
/-! # LeanFX2.Term.PreservesTerm.TierZeroAndUnary

Tier 0 atom lifts plus Tier 1 unary / binder cong lifts for
`RawStep.par`-to-`Step.par` term-construction subject reduction.

Covers (21 ctors):
* Tier 0 atoms (9): unit, boolTrue, boolFalse, natZero, listNil,
  optionNone, interval0, interval1, var; plus the universeCode atom
  and the cumulUp unary cong (Tier 1).
* Tier 1 unary cong (8): natSucc, optionSome, eitherInl, eitherInr,
  intervalOpp, modIntro, subsume, recordIntro.
* Tier 1 binders (3): lam, lamPi, pathLam.
