...
/-! ### K12.20.U2 neutral CR3 wrappers — SN-direct arms

The previous `*_of_progress_closure` lemmas are the raw constructor
direction for SN-direct `Reducible` arms.  These neutral wrappers record
the actual CR3 contract at the typed boundary: the source raw term is
neutral, and every non-trivial progress reduct is SN.  For the ten
SN-direct arms this is already enough because their `Reducible` body is
definitionally just typed strong normalization.

These lemmas intentionally do NOT claim the full typed CR3 theorem for
compound arms.  Arrow, sigma, path, glue, equiv, refine, record, and
codata still need their closure fields, and the weak eliminator arms still
need separate neutral-head closure arguments.
-/

/-- Neutral CR3 wrapper for the unit SN-direct arm. -/
theorem Reducible.unit_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {sourceRaw : RawTerm scope}
    (sourceTerm : Term context Ty.unit sourceRaw)
...
/-- Neutral CR3 wrapper for the bool SN-direct arm. -/
theorem Reducible.bool_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {sourceRaw : RawTerm scope}
    (sourceTerm : Term context Ty.bool sourceRaw)
...
/-- Neutral CR3 wrapper for the nat SN-direct arm. -/
theorem Reducible.nat_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {sourceRaw : RawTerm scope}
    (sourceTerm : Term context Ty.nat sourceRaw)
...
/-- Neutral CR3 wrapper for the empty SN-direct arm. -/
theorem Reducible.empty_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {sourceRaw : RawTerm scope}
    (sourceTerm : Term context Ty.empty sourceRaw)
...
/-- Neutral CR3 wrapper for the interval SN-direct arm. -/
theorem Reducible.interval_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {sourceRaw : RawTerm scope}
    (sourceTerm : Term context Ty.interval sourceRaw)
...
/-- Neutral CR3 wrapper for the universe SN-direct arm. -/
theorem Reducible.universe_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {universeLevel : UniverseLevel}
    {levelLe : universeLevel.toNat + 1 ≤ level}
...
/-- Neutral CR3 wrapper for the type-variable SN-direct arm. -/
theorem Reducible.tyVar_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {tyVarPosition : Fin scope}
    {sourceRaw : RawTerm scope}
...
/-- Neutral CR3 wrapper for the session SN-direct arm. -/
theorem Reducible.session_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {protocolStep : RawTerm scope}
    {sourceRaw : RawTerm scope}
...
/-- Neutral CR3 wrapper for the effect SN-direct arm. -/
theorem Reducible.effect_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {carrierType : Ty level scope}
    {effectTag : RawTerm scope}
...
/-- Neutral CR3 wrapper for the modal SN-direct arm. -/
theorem Reducible.modal_of_neutral_progress_closure
    {mode : Mode} {level scope : Nat}
    {context : Ctx mode level scope}
    {modalityTag : Nat}
    {carrierType : Ty level scope}
