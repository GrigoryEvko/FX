...
#assert_cast_operator_dependent_budget LeanFX2 1378
...
-- D3.6-P3 (2026-05-09): ships `Step.par.uaToEquivCong` (typed mirror
-- of `RawStep.par.uaToEquivCong`); the matching
